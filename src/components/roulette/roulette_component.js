...
export default class RouletComponent extends Component {
  render () {
    return (
      <main>
          ...
          <div className='container roullete'>
            <div className='row'>
              <div className='progress'>
                <div className='determinate' style={{width: '70%'}}><img src='assets/img/eclipse.png' alt='' />
              </div>
            </div>
...
=======
              ...
              <div className='number yell-red active-num'>
                <div className='upper_shadow' > </div>
...
>>>>>>> merge
        ...
        <div className='row winner-table'>
          <div className='col s12 m4 l12 xl4'>
            ...
            <div className='col s6 center-align'><button onClick={() => this.props.bet('PURPLE')} className='bet bttt pupr waves-effect waves-light'>BET</button></div>
          ...
          <div className='col s12 m4 l12 xl4 exlusive'>
            <div className='col s6 center-align white-text teta'><span>1-7</span><br />win 2X</div>
            <div className='col s6 center-align'><button onClick={() => this.props.bet('BLUE')} className='bet bttt zero waves-effect waves-light'>BET</button></div>
            ...
            <div className='col s12 center-align namess' style={{paddingLeft: '0', paddingRight: '0'}}>
            <div className='col s3 left'> <img src='assets/img/ava.png' alt='' style={{width: '40px', height: '40px', borderRadius: '50%', float: 'right'}} />
            <div className='col s6 center-align nnnn' style={{padding: '0'}}> Ice cube</div>
            <div className='col s3 left-align nnnn'> 207</div>
          </div>
        </div>
        <div className='col s12 m4 l12 xl4'>
          <div className='col s6 center-align white-text teta'><span>1-7</span><br />win 2X</div>
          <div className='col s6 center-align'><button onClick={() => this.props.bet('RED')} className='bet bttt yell-red waves-effect waves-light'>BET</button></div>
